...
use klever_sc_modules::{pause::PauseModule, staking::StakingModule};
...
const PRICE_AGGREGATOR_PATH_EXPR: KleverscPath =
    KleverscPath::new("kleversc:output/klv-price-aggregator-sc.mxsc.json");
...
fn test_price_aggregator_submit() {
    ...
    world
        ...
        .whitebox(klv_price_aggregator_sc::contract_obj, |sc| {
