...
klever_sc_wasm_adapter::endpoints! {
    ...
    (
        ...
        stake => stake
        unstake => unstake
        proposeKdaSafeSetCurrentTransactionBatchStatus => propose_kda_safe_set_current_transaction_batch_status
        proposeMultiTransferKdaBatch => propose_multi_transfer_kda_batch
        ...
        initSupplyKdaSafe => init_supply_kda_safe
        initSupplyMintBurnKdaSafe => init_supply_mint_burn_kda_safe
        changeFeeEstimatorContractAddress => change_fee_estimator_contract_address
        changeKlvToEthGasLimit => change_klv_to_eth_gas_limit
        changeDefaultPricePerGasUnit => change_default_price_per_gas_unit
        changeTokenTicker => change_token_ticker
        kdaSafeAddTokenToWhitelist => kda_safe_add_token_to_whitelist
        setMultiTransferOnKdaSafe => set_multi_transfer_on_kda_safe
        setKdaSafeOnMultiTransfer => set_kda_safe_on_multi_transfer
        kdaSafeRemoveTokenFromWhitelist => kda_safe_remove_token_from_whitelist
        kdaSafeSetMaxTxBatchSize => kda_safe_set_max_tx_batch_size
        kdaSafeSetMaxTxBatchBlockDuration => kda_safe_set_max_tx_batch_block_duration
        kdaSafeSetMaxBridgedAmountForToken => kda_safe_set_max_bridged_amount_for_token
        multiTransferKdaSetMaxBridgedAmountForToken => multi_transfer_kda_set_max_bridged_amount_for_token
