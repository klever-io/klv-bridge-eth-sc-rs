...
pub struct KDASafeProxy;

impl<Env, From, To, Gas> TxProxyTrait<Env, From, To, Gas> for KDASafeProxy
where
    Env: TxEnv,
    From: TxFrom<Env>,
    To: TxTo<Env>,
    Gas: TxGas<Env>,
{
    type TxProxyMethods = KDASafeProxyMethods<Env, From, To, Gas>;

    fn proxy_methods(self, tx: Tx<Env, From, To, (), Gas, (), ()>) -> Self::TxProxyMethods {
        KDASafeProxyMethods { wrapped_tx: tx }
    }
}

pub struct KDASafeProxyMethods<Env, From, To, Gas>
where
    Env: TxEnv,
    From: TxFrom<Env>,
    To: TxTo<Env>,
...
#[rustfmt::skip]
impl<Env, From, Gas> KDASafeProxyMethods<Env, From, (), Gas>
where
    Env: TxEnv,
    Env::Api: VMApi,
    From: TxFrom<Env>,
...
#[rustfmt::skip]
impl<Env, From, To, Gas> KDASafeProxyMethods<Env, From, To, Gas>
where
    Env: TxEnv,
    Env::Api: VMApi,
    From: TxFrom<Env>,
    ...
    Gas: TxGas<Env>,
{
    ...
    >(
        ...
        start_index: Arg0,
        end_index: Arg1,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, ManagedVec<Env::Api, KdaTokenPayment<Env::Api>>> {
        self.wrapped_tx
            .payment(NotPayable)
