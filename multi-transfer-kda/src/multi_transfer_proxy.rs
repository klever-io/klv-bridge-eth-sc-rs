...
pub struct MultiTransferKdaProxy;

impl<Env, From, To, Gas> TxProxyTrait<Env, From, To, Gas> for MultiTransferKdaProxy
where
    Env: TxEnv,
    From: TxFrom<Env>,
    To: TxTo<Env>,
    Gas: TxGas<Env>,
{
    type TxProxyMethods = MultiTransferKdaProxyMethods<Env, From, To, Gas>;

    fn proxy_methods(self, tx: Tx<Env, From, To, (), Gas, (), ()>) -> Self::TxProxyMethods {
        MultiTransferKdaProxyMethods { wrapped_tx: tx }
    }
}

pub struct MultiTransferKdaProxyMethods<Env, From, To, Gas>
where
    Env: TxEnv,
    From: TxFrom<Env>,
    To: TxTo<Env>,
...
#[rustfmt::skip]
impl<Env, From, Gas> MultiTransferKdaProxyMethods<Env, From, (), Gas>
where
    Env: TxEnv,
    Env::Api: VMApi,
    From: TxFrom<Env>,
...
#[rustfmt::skip]
impl<Env, From, To, Gas> MultiTransferKdaProxyMethods<Env, From, To, Gas>
where
    Env: TxEnv,
    Env::Api: VMApi,
    From: TxFrom<Env>,
...
where
    ...
    Gas: TxGas<Env>,
{
    pub fn batch_transfer_kda_token<
        Arg0: ProxyArg<u64>,
    ...
    >(
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("batchTransferKdaToken")
            .argument(&batch_id)
            .argument(&transfers)
            .original_result()
    }
    ...
    pub fn set_kda_safe_contract_address<
        Arg0: ProxyArg<OptionalValue<ManagedAddress<Env::Api>>>,
    >(
        self,
        opt_new_address: Arg0,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("setKdaSafeContractAddress")
            .argument(&opt_new_address)
            .original_result()
    }
    ...
    pub fn kda_safe_contract_address(
        self,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, ManagedAddress<Env::Api>> {
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("getKdaSafeContractAddress")
            .original_result()
    }
