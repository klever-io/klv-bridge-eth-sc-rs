    ...
    Gas: TxGas<Env>,
{
    ...
    pub fn propose_kda_safe_set_current_transaction_batch_status<
        Arg0: ProxyArg<u64>,
        Arg1: ProxyArg<MultiValueEncoded<Env::Api, transaction::transaction_status::TransactionStatus>>,
    >(
        self,
        kda_safe_batch_id: Arg0,
        tx_batch_status: Arg1,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, usize> {
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("proposeKdaSafeSetCurrentTransactionBatchStatus")
            .argument(&kda_safe_batch_id)
    ...
    >(
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("proposeMultiTransferKdaBatch")
    ...
    pub fn pause_kda_safe(
        self,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, ()> {
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("pauseKdaSafe")
            .original_result()
    }

    pub fn unpause_kda_safe(
        self,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, ()> {
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("unpauseKdaSafe")
            .original_result()
    }

    pub fn init_supply_kda_safe<
        Arg0: ProxyArg<TokenIdentifier<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .raw_call("initSupplyKdaSafe")
            .argument(&token_id)
            .argument(&amount)
            .original_result()
    }

    pub fn init_supply_mint_burn_kda_safe<
        Arg0: ProxyArg<TokenIdentifier<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    ...
    >(
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("initSupplyMintBurnKdaSafe")
            .argument(&token_id)
    ...
    pub fn change_klv_to_eth_gas_limit<
        Arg0: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        new_gas_limit: Arg0,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("changeKlvToEthGasLimit")
    ...
    pub fn kda_safe_add_token_to_whitelist<
        Arg0: ProxyArg<TokenIdentifier<Env::Api>>,
        Arg1: ProxyArg<ManagedBuffer<Env::Api>>,
        Arg2: ProxyArg<bool>,
        Arg3: ProxyArg<bool>,
    ...
    >(
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("kdaSafeAddTokenToWhitelist")
            .argument(&token_id)
            .argument(&ticker)
    ...
    pub fn set_multi_transfer_on_kda_safe(
        self,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, ()> {
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("setMultiTransferOnKdaSafe")
            .original_result()
    }

    pub fn set_kda_safe_on_multi_transfer(
        self,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, ()> {
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("setKdaSafeOnMultiTransfer")
            .original_result()
    }

    pub fn kda_safe_remove_token_from_whitelist<
        Arg0: ProxyArg<TokenIdentifier<Env::Api>>,
    >(
        self,
        token_id: Arg0,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("kdaSafeRemoveTokenFromWhitelist")
            .argument(&token_id)
            .original_result()
    }
    ...
    pub fn kda_safe_set_max_tx_batch_size<
        Arg0: ProxyArg<usize>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("kdaSafeSetMaxTxBatchSize")
    ...
    pub fn kda_safe_set_max_tx_batch_block_duration<
        Arg0: ProxyArg<u64>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("kdaSafeSetMaxTxBatchBlockDuration")
    ...
    pub fn kda_safe_set_max_bridged_amount_for_token<
        Arg0: ProxyArg<TokenIdentifier<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("kdaSafeSetMaxBridgedAmountForToken")
            .argument(&token_id)
            .argument(&max_amount)
            .original_result()
    }
    ...
    pub fn multi_transfer_kda_set_max_bridged_amount_for_token<
        Arg0: ProxyArg<TokenIdentifier<Env::Api>>,
        Arg1: ProxyArg<BigUint<Env::Api>>,
    >(
        self,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("multiTransferKdaSetMaxBridgedAmountForToken")
            .argument(&token_id)
            .argument(&max_amount)
            .original_result()
    }
    ...
    pub fn multi_transfer_kda_set_max_refund_tx_batch_size<
        Arg0: ProxyArg<usize>,
    >(
        self,
        new_max_tx_batch_size: Arg0,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("multiTransferKdaSetMaxRefundTxBatchSize")
            .argument(&new_max_tx_batch_size)
            .original_result()
    }
    ...
    pub fn multi_transfer_kda_set_max_refund_tx_batch_block_duration<
        Arg0: ProxyArg<u64>,
    >(
        self,
        new_max_tx_batch_block_duration: Arg0,
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("multiTransferKdaSetMaxRefundTxBatchBlockDuration")
            .argument(&new_max_tx_batch_block_duration)
            .original_result()
    }
    ...
    pub fn multi_transfer_kda_set_wrapping_contract_address<
    ...
    >(
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("multiTransferKdaSetWrappingContractAddress")
    ...
    pub fn kda_safe_address(
        ...
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("getKdaSafeAddress")
            .original_result()
    }

    pub fn multi_transfer_kda_address(
        self,
    ) -> TxTypedCall<Env, From, To, NotPayable, Gas, ManagedAddress<Env::Api>> {
        self.wrapped_tx
            .payment(NotPayable)
            .raw_call("getMultiTransferKdaAddress")
            .original_result()
    }
